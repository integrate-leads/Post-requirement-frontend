...
const Index: React.FC = () => {
  ...
  return (
    <Box style={{ overflowX: 'hidden' }}>
        ...
        <Container size="lg">
          <Stack gap="xl" maw={900} mx="auto" ta="center">
            <Box>
              ...
              <Title order={1} fz={{ base: 30, md: 48 }} lh={1.15} c="gray.9" fw={700} style={{ letterSpacing: '-0.02em' }}>
                Why Integrate Leads
              </Title>
            </Box>
            <Text size="lg" c="gray.6" lh={1.85}>
            ...
            <SimpleGrid cols={{ base: 2, sm: 4 }} spacing="md" px={{ base: 0, sm: 'xl' }}>
              {hiringTypes.map((type) => (
                <Card
                  ...
                  styles={{ root: { boxShadow: '0 1px 3px rgba(0,0,0,0.06)' } }}
                >
                  <Stack gap="sm" align="center" ta="center">
                    <ThemeIcon size={52} radius="xl" variant="light" color={type.color}>
                      <type.icon size={26} stroke={1.5} />
                    </ThemeIcon>
      ...
      {/* Services Section */}
      <Box id="services" py={{ base: 64, md: 88 }} bg="white">
        <Container size="lg">
          <Stack align="center" gap="sm" mb={56}>
            <Text size="xs" fw={600} c="blue.6" tt="uppercase" style={{ letterSpacing: '0.12em' }}>
              Our Services
            </Text>
            <Title order={2} ta="center" fz={{ base: 26, md: 38 }} fw={700} c="gray.9">
              What We Offer
            </Title>
            ...
            {services.map((service) => (
              ...
              >
                <Stack gap="lg" align="center" ta="center" style={{ flex: 1 }}>
                  <ThemeIcon size={76} radius="xl" variant="light" color={service.color}>
                    <service.icon size={38} stroke={1.5} />
                  </ThemeIcon>
                  <Text fw={600} size="xl">{service.title}</Text>
                  <Text size="sm" c="dimmed" lh={1.75} style={{ flex: 1 }}>
                    {service.description}
                  </Text>
                  <Button
                    variant="light"
      ...
      {/* Highlights Section */}
      <Box py={{ base: 64, md: 88 }} bg="gray.0">
        <Container size="lg">
          <Stack align="center" gap="sm" mb={56}>
            <Text size="xs" fw={600} c="blue.6" tt="uppercase" style={{ letterSpacing: '0.12em' }}>
              Platform Highlights
            ...
            {highlights.map((highlight, index) => (
              ...
              >
                <Stack gap="md" align="center" ta="center">
                  <ThemeIcon size={58} radius="xl" variant="light" color="blue">
                    <highlight.icon size={28} stroke={1.5} />
                  </ThemeIcon>
                  <Text size="sm" fw={500} lh={1.65}>
                    {highlight.text}
                  </Text>
                </Stack>
              </Card>
      ...
      <Box py={{ base: 64, md: 88 }} bg="white">
        <Container size="lg">
          <SimpleGrid cols={{ base: 1, md: 2 }} spacing={64} style={{ alignItems: 'center' }}>
            <Box>
              <Text size="xs" fw={600} c="blue.6" tt="uppercase" mb="xs" style={{ letterSpacing: '0.12em' }}>
                Why Choose Us
              </Text>
              <Title order={2} fz={{ base: 26, md: 38 }} fw={700} c="gray.9" mb="lg">
                Built for Modern Recruitment
              </Title>
              <Text c="dimmed" lh={1.85} mb="xl" size="md">
              ...
              <SimpleGrid cols={2} spacing="md">
                {whyChooseUs.map((item) => (
                  <Group key={item} gap="sm" wrap="nowrap">
                    ...
                    <Text size="sm" c="gray.7" fw={500}>{item}</Text>
                  </Group>
                ))}
              </SimpleGrid>
            </Box>
              ...
              {features.map((feature) => (
                ...
                >
                  <Group gap="md" wrap="nowrap">
                    ...
                    <Box>
                      <Text fw={600} size="md" mb={4} c="gray.9">{feature.title}</Text>
      ...
      <Box id="contact" py={{ base: 56, md: 88 }} bg="gray.0">
        <Container size="lg">
          <SimpleGrid cols={{ base: 1, lg: 2 }} spacing={{ base: 32, lg: 56 }}>
            {/* Left - Info */}
            <Box>
              <Text size="xs" fw={600} c="blue.6" tt="uppercase" mb="xs" style={{ letterSpacing: '0.12em' }}>
                Contact Us
              </Text>
              <Title order={2} fz={{ base: 26, md: 34 }} fw={700} c="gray.9" mb="md">
                Get In Touch
              </Title>
              <Text c="dimmed" lh={1.75} mb="xl" maw={400} size="md">
              ...
              <Stack gap="lg">
                ...
                <Group gap="md" wrap="nowrap">
                  ...
                  <Box>
                    <Text size="xs" c="dimmed" fw={600}>Hours</Text>
