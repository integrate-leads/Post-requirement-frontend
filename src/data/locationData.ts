...
// Work Types
export const WORK_TYPES = ['Hybrid', 'Remote', 'Onsite'];

// Visa Status Options (USA)
export const USA_VISA_STATUS = [
  'US Citizen',
  'Green Card',
  'H1B',
  'H4 EAD',
...
// USA Document Options
export const USA_DOCUMENT_OPTIONS = [
  'Upload Updated Resume',
  'Upload Recent Travel History I-94',
  'Upload Visa Copy'
];
