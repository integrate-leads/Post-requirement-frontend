...
// Super admin email - only this email gets super admin role
const SUPER_ADMIN_EMAIL = 'superadmin@recruitpro.com';

// Mock users database
const MOCK_USERS: Record<string, { password: string; name: string; company?: string }> = {
  'superadmin@recruitpro.com': { password: 'admin123', name: 'Super Admin' },
